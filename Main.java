...
public class Main {
    public static void main(String[] args) {
        student student1 = new student(1, "Raju", "BCA", 90);
        student student2 = new student(4, "Sudha", "MCA", 30);
        student student3 = new student(1, "Gagan", "BCA", 40);
        student student4 = new student(4, "Harsha", "MCA", 20);
        student student5 = new student(4, "Mohan", "MCA", 60);
        ...
        for (student student : new student[] { student1, student2, student3, student4, student5 }) {
            System.out.print(student.getStudentName() + "\t\t\t" + student.getstudentDept() + "\t\t\t "
                    + student.getstudentSem() + "\t\t");
